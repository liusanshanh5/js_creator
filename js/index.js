...
function main(){
	...
	$(".page6 p").eq(0).Tab("2.13rem","1.36rem","2.72rem","2.48rem");
	$(".page6 p").eq(1).Tab("7.16rem","1.33rem","0.34rem","0.83rem");
	$(".page6 p").eq(2).Tab("6.87rem","4.01rem","0.63rem","0.55rem");
	$(".page6 p").eq(3).Tab("0.44rem","1.56rem","2.73rem","2.22rem");
	$(".page6 p").eq(4).Tab("0rem","1.5rem","0.48rem","1.06rem");
	$(".page6 p").eq(5).Tab("3.97rem","1.45rem","2.95rem","2.09rem");
	$(".page6 p").eq(6).Tab("6.95rem","11.35rem","0.31rem","0.35rem");
	$(".page6 p").eq(7).Tab("3.28rem","5.23rem","0.63rem","0.5rem");
	
	$(".page6 p").eq(11).Tab("4.12rem","5.24rem","1.7rem","2rem");
	$(".page6 p").eq(12).Tab("1.71rem","5.75rem","2.1rem","2.5rem");
	$(".page6 p").eq(13).Tab("4.11rem","7.34rem","2.11rem","2.61rem");
	$(".page6 p").eq(14).Tab("1.31rem","8.34rem","2.5rem","2.1rem");
	$(".page6 p").eq(15).Tab("4.01rem","10.04rem","1.8rem","2.2rem");
	$(".page6 p").eq(16).Tab("1.91rem","10.54rem","1.7rem","1.7rem");
	...
	$(".page4 p").eq(1).Tab("0.76rem","1.56rem","2.99rem","5.13rem");
	$(".page4 p").eq(2).Tab("3.19rem","5.08rem","0.56rem","1.58rem");
	$(".page4 p").eq(3).Tab("3.34rem","3.89rem","0.43rem","2.83rem");
	$(".page4 p").eq(4).Tab("3.75rem","2.24rem","0.87rem","4.46rem");
	$(".page4 p").eq(5).Tab("3.79rem","5.04rem","0.43rem","1.56rem");
	$(".page4 p").eq(6).Tab("3.77rem","2.4rem","2.52rem","4.3rem");
	$(".page4 p").eq(7).Tab("3.77rem","4.86rem","1.85rem","1.83rem");
	$(".page4 p").eq(8).Tab("3.74rem","4.23rem","3.73rem","2.5rem");
	$(".page4 p").eq(9).Tab("3.81rem","6.15rem","1.5rem","0.55rem");
	$(".page4 p").eq(10).Tab("3.75rem","5.95rem","3.75rem","0.76rem");
	$(".page4 p").eq(11).Tab("3.78rem","6.69rem","1.83rem","0.22rem");
	$(".page4 p").eq(12).Tab("3.75rem","6.70rem","1.03rem","0.31rem");
	$(".page4 p").eq(13).Tab("3.76rem","6.70rem","1.52rem","0.71rem");
	$(".page4 p").eq(14).Tab("3.75rem","6.69rem","3.75rem","3.1rem");
	$(".page4 p").eq(15).Tab("3.77rem","6.71rem","1.68rem","1.8rem");
	$(".page4 p").eq(16).Tab("3.76rem","6.71rem","2.88rem","4.6rem");
	$(".page4 p").eq(17).Tab("3.75rem","6.70rem","1.21rem","3.45rem");
	$(".page4 p").eq(18).Tab("3.75rem","6.70rem","0.18rem","1.75rem");
	$(".page4 p").eq(19).Tab("3.64rem","6.71rem","0.12rem","2.92rem");
	$(".page4 p").eq(20).Tab("1.74rem","6.73rem","2.01rem","5.02rem");
	$(".page4 p").eq(21).Tab("3.14rem","6.7rem","0.62rem","1.14rem");
	$(".page4 p").eq(22).Tab("1.98rem","6.7rem","1.77rem","1.93rem");
	$(".page4 p").eq(23).Tab("0.58rem","6.73rem","3.13rem","1.44rem");
	$(".page4 p").eq(24).Tab("2.46rem","6.7rem","1.3rem","0.31rem");
	$(".page4 p").eq(25).Tab("0rem","6.24rem","3.63rem","0.47rem");
	$(".page4 p").eq(26).Tab("0.53rem","5.79rem","3.17rem","0.9rem");
	$(".page4 p").eq(27).Tab("2.31rem","5.96rem","1.45rem","0.75rem");
	$(".page4 p").eq(28).Tab("1.75rem","5.11rem","2.03rem","1.61rem");
